...
public class DelaunayTriangulation
{
    ...
    // the Bounding Box, {{minX,minY,minZ} , {maxX,maxY,maxZ}}
    ...
    /*
     * SMF file has an OFF like format (a face (f) is presented by the indexes of
     * its points - starting from 1, and not from 0): begin v maxX maxY maxZ ... v xn yn
    ...
    /**
     * return the min point of the bounding box of this triangulation {{minX,minY,minZ}}
     */
    ...
    /**
     * return the max point of the bounding box of this triangulation {{maxX,maxY,maxZ}}
     */
